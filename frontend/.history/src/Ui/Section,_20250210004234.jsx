...
const Section = ({ title, icon: Icon, children, onAdd, addText }) => (
  <section className="p-4 space-y-3 border-b border-slate-200 dark:border-slate-700 last:border-0">
    <div className="flex justify-between items-center">
      ...
      {onAdd && (
        <button onClick={onAdd} className="flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-accent/10 dark:bg-accent/70 text-accent dark:text-white hover:bg-accent/30 dark:hover:bg-accent/30 transition-colors">
