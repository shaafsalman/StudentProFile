...
const Section = ({ title, icon: Icon, children, onAdd, addText }) => (
  <section className="p-4 space-y-3 border-b border-slate-200 dark:border-slate-700 last:border-0">
    <div className="flex justify-between items-center">
      ...
      {onAdd && (
        <button onClick={onAdd} className="flex items-center gap-1.5 px-3 py-1.5 bg-accent/70 dark:bg-accent/70  dark:text-accent/30 rounded-lg hover:bg-accent/10 dark:hover:bg-accent/30 transition-colors">
