    ...
    <div className="h-screen w-screen overflow-hidden flex">
      ...
      <div className={`h-full transition-all duration-300 relative ${
        ...
        <div className="h-full mb-4">
          <div className="h-[calc(100%-5rem)] pt-[3.25rem] overflow-y-auto scrollbar-thin">
            <div className="max-w-4xl mx-auto p-8">
              <Preview data={data} theme={currentTheme} />
            </div>
          </div>
          <div className="flex justify-center items-center max-w-4xl bg-card-light rounded-xl p-2">
          <ThemeSelector 
