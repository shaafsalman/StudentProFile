...
export const resumeThemes = {
  ...
  appleMinimal: {
    name: 'Apple',
    styles: {
      container: 'max-w-[800px] mx-auto bg-white p-16',
      header: 'mb-16',
      name: 'text-5xl font-light tracking-tight text-gray-900 mb-6',
      contact: 'text-gray-500 flex gap-6 text-sm font-light',
      sectionTitle: 'text-xl font-medium text-gray-900 mb-8',
      sectionContainer: 'mb-16 last:mb-0',
      itemTitle: 'text-base font-medium text-gray-900',
      itemSubtitle: 'text-base font-light text-gray-500',
      dates: 'text-sm font-light text-gray-400',
      description: 'text-base font-light text-gray-600 leading-relaxed',
      skills: 'px-4 py-2 bg-gray-50 rounded-full text-sm font-light text-gray-600 hover:bg-gray-100 transition-colors duration-200',
      subtleBox: 'rounded-2xl bg-gray-50/50 p-8 backdrop-blur-sm',
      grid: 'grid grid-cols-12 gap-8',
      mainContent: 'col-span-8',
      sidebar: 'col-span-4 space-y-12',
      highlight: 'text-gray-900 font-medium',
      infoCard: 'rounded-2xl bg-gray-50 p-6 backdrop-blur-sm',
      separator: 'w-16 h-px bg-gray-200 my-8',
      button: 'inline-flex items-center justify-center rounded-full px-4 py-2 text-sm font-light text-gray-600 hover:bg-gray-100 transition-all duration-200',
      skillGrid: 'grid grid-cols-2 gap-3'
    }
  }
