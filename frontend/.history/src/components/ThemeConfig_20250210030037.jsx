...
export const resumeThemes = {
  ...
  appleMinimal: {
    name: 'Apple',
    styles: {
      container: 'max-w-[800px] mx-auto bg-white px-16 py-20',
      header: 'mb-20',
      name: 'text-6xl font-light tracking-tight text-gray-900 mb-8',
      contact: 'text-lg text-gray-500 space-x-8 font-light',
      sectionTitle: 'text-2xl font-medium text-gray-900 mb-6',
      sectionContainer: 'mb-20 last:mb-0',
      itemTitle: 'text-lg font-medium text-gray-900',
      itemSubtitle: 'text-base text-gray-500',
      dates: 'text-base font-light text-gray-400',
      description: 'text-base text-gray-600 leading-relaxed',
      skills: 'inline-flex px-4 py-1.5 bg-gray-50 rounded-full text-sm text-gray-600 hover:bg-gray-100 transition-colors duration-200',
      subtleBox: 'rounded-3xl bg-gray-50 p-10',
      grid: 'grid grid-cols-3 gap-16',
      mainContent: 'col-span-2',
      sidebar: 'col-span-1 space-y-16',
      separator: 'w-full h-px bg-gray-100 my-16',
      button: 'inline-flex items-center text-sm text-gray-500 hover:text-gray-900 transition-colors duration-200',
      skillsGrid: 'flex flex-wrap gap-2',
      summaryText: 'text-xl font-light text-gray-600 leading-relaxed',
      experienceCard: 'group pt-8 first:pt-0 border-t last:border-b pb-8 last:pb-0 border-gray-100',
      projectCard: 'rounded-2xl bg-gray-50 p-8 group hover:bg-gray-100 transition-colors duration-200',
      sidebarTitle: 'text-lg font-medium text-gray-900 mb-4',
      sidebarSection: 'space-y-6',
      hoverReveal: 'opacity-0 group-hover:opacity-100 transition-opacity duration-200',
      sidebarText: 'text-sm text-gray-500 leading-relaxed'
    }
  }
