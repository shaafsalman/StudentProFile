    ...
    <>
      <aside className={themeStyles.sidebar}>
        <div className={themeStyles.sidebarSection}>
          ...
          {data.personalInfo.email && (
            <div className={themeStyles.sidebarContent}>{data.personalInfo.email}</div>
          )}
          {data.personalInfo.phone && (
            <div className={themeStyles.sidebarContent}>{data.personalInfo.phone}</div>
          )}
          {data.personalInfo.location && (
            <div className={themeStyles.sidebarContent}>{data.personalInfo.location}</div>
          )}
        </div>

        {data.skills.length > 0 && (
          <div className={themeStyles.sidebarSection}>
            <h2 className={themeStyles.sidebarTitle}>Expertise</h2>
            <div className={themeStyles.skillsContainer}>
              {data.skills.map((skill, index) => (
                <span key={index} className={themeStyles.skills}>
                  {skill}
                </span>
          ...
          <div className={themeStyles.sidebarSection}>
            ...
            {data.education.map((edu, index) => (
              <div key={index} className={themeStyles.sidebarItem}>
                ...
                <div className={themeStyles.sidebarSubtitle}>
                  {edu.degree}
                  {edu.fieldOfStudy && ` in ${edu.fieldOfStudy}`}
                </div>
      ...
      <main className={themeStyles.main}>
        {data.experience.length > 0 && (
          <section className={themeStyles.mainSection}>
            ...
            {data.experience.map((exp, index) => (
              <div key={index} className={themeStyles.experienceItem}>
    ...
    <>
      ...
      <div className={themeStyles.grid}>
        <div className={themeStyles.mainContent}>
          ...
          {data.projects.length > 0 && (
            <section className={themeStyles.sectionContainer}>
              <h2 className={themeStyles.sectionTitle}>Selected Projects</h2>
        ...
        <div className={themeStyles.sidebar}>
          ...
          <div className={themeStyles.sidebarSection}>
            <p className={themeStyles.sidebarText}>
              This resume follows Apple's design principles of clarity, deference, and depth.
            </p>
          </div>
        </div>
      </div>
