...
export const resumeThemes = {
  ...
  professionalPlus: {
    ...
    styles: {
      // Changed from grid-cols-4 to grid-cols-12 for finer control
      container: 'grid grid-cols-12 bg-white max-w-[800px] mx-auto min-h-[1000px]',
      // Main content now spans 8 columns instead of 9
      header: 'col-span-8 p-4 pl-12',
      ...
      // Sidebar now spans 4 columns instead of 3
      sidebar: 'col-span-4 bg-gray-900 text-white p-6 flex flex-col gap-12 sticky top-0 h-screen',
      main: 'col-span-8 p-8 pl-12',
