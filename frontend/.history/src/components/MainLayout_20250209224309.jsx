...
import { Download, ChevronRight, ChevronLeft, Maximize2, Minimize2, Settings, Menu, X, PanelLeftOpen, PanelLeftClose, Plus, Star, Mail, Phone, MapPin, Book, Briefcase, Code, Tool } from 'lucide-react';
...
const MainLayout = () => {
  ...
  const navigationItems = [
    ...
    { id: 'skills', label: 'Skills', icon: Tool, color: 'bg-red-500' }
  ];
