...
export const ThemeSelector = ({ currentTheme, onThemeChange, currentFont, onFontChange, currentAccentColor, onAccentColorChange }) => {
  ...
  return (
    <div className="relative space-y-6 p-4 bg-white shadow-lg rounded-lg">
      ...
      {/* Font & Color Toggle */}
      <div className="absolute top-3 right-3 flex items-center space-x-3 cursor-pointer bg-gray-100 p-2 rounded-lg shadow-md hover:bg-gray-200" onClick={() => setMenuOpen(!menuOpen)}>
      ...
      {/* Hover Menu - Positioned Above */}
      {menuOpen && (
        <div className="absolute bottom-12 right-3 w-48 bg-white border rounded-lg shadow-lg p-3 space-y-4">
          {/* Font Selector */}
          <div>
