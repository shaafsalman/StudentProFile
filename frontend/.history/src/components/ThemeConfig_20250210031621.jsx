...
export const resumeThemes = {
  ...
  professionalPlus: {
    ...
    styles: {
      ...
      sidebar: ' bg-gray-900 text-white p-6 flex flex-col gap-6 sticky top-0 h-screen',
      main: 'p-4 pl-12',
      sidebarTitle: 'text-xs font-bold uppercase tracking-tighter text-gray-400 mb-3',
