    ...
    <>
      ...
      <div className={themeStyles.grid}>
        <div className={themeStyles.mainContent}>
          {data.personalInfo.summary && (
            <section className={themeStyles.sectionContainer}>
              <div className={themeStyles.subtleBox}>
                <p className={themeStyles.description}>
                  {data.personalInfo.summary}
                </p>
              </div>
          ...
          {data.projects.length > 0 && (
            <section className={themeStyles.sectionContainer}>
              ...
              <div className="space-y-8">
                {data.projects.map((project, index) => (
                  <div key={index} className={themeStyles.infoCard}>
                    ...
                    {project.technologies?.length > 0 && (
                      <div className="mt-4 flex flex-wrap gap-2">
                        {project.technologies.map((tech, idx) => (
                          <span key={idx} className="text-sm font-light text-gray-500">
                            {tech}
        ...
        <div className={themeStyles.sidebar}>
          {data.skills.length > 0 && (
            <div>
              ...
              <div className={themeStyles.skillGrid}>
                {data.skills.map((skill, index) => (
                  <span key={index} className={themeStyles.skills}>
                    {skill}
                  </span>
          ...
          <div className="text-sm font-light text-gray-400">
            This resume was crafted with attention to detail and a focus on clarity.
          </div>
        </div>
      </div>
    </>
