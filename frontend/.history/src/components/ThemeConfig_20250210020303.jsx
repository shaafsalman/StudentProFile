...
export const ThemeSelector = ({ currentTheme, onThemeChange, currentFont, onFontChange, currentAccentColor, onAccentColorChange }) => {
  ...
  return (
    <div className="relative space-y-6 p-4 bg-white shadow-lg rounded-lg">
    {/* Theme Selector Row */}
    <div className="flex justify-between items-center">
      {/* Font & Color Selector in a Row */}
    ...
    <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-3 cursor-pointer bg-gray-100 p-2 rounded-lg shadow-md hover:bg-gray-200 menu-container"
             onClick={() => setFontMenuOpen(!fontMenuOpen)}>
          <span className={`${currentFont} text-base font-semibold`}>Font</span>
