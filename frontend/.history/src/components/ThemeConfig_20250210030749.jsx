...
export const resumeThemes = {
  ...
  professionalPlus: {
    ...
    styles: {
      ...
      header: 'col-span-8 col-start-1 p-8',
      ...
      description: 'text-gray-600 mt-2 leading-relaxed',
      main: 'col-span-8 col-start-1 p-8 pt-0',
      
      // Right sidebar specific styles
      sidebar: 'col-span-4 col-start-9 bg-gray-900 min-h-full p-6 sticky top-0 max-h-screen overflow-y-auto',
      sidebarTitle: 'text-sm font-bold uppercase tracking-widest text-gray-400 mb-3 pb-2 border-b border-gray-800',
      sidebarSection: 'mb-6 last:mb-0',
      sidebarContent: 'text-gray-300 text-sm leading-relaxed',
      skills: 'inline-block bg-gray-800 px-2.5 py-1 rounded text-gray-300 text-xs mr-1.5 mb-1.5 hover:bg-gray-700 transition-colors',
      skillsContainer: 'flex flex-wrap',
      sidebarItem: 'mb-3 last:mb-0 pb-3 last:pb-0 border-b border-gray-800 last:border-0',
      sidebarDate: 'text-gray-500 text-xs mt-1'
    }
  },
  minimalistCards: {
