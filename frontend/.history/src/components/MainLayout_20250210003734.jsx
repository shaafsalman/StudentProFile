  ...
  return (
    <div className="h-screen w-screen overflow-hidden flex">
      ...
      <div className={`h-full transition-all duration-300 relative ${
        ...
        <div className="absolute top-0 left-0 right-0 z-10 px-6 py-3 bg-white/50 backdrop-blur-sm">
        ...
        <div className="h-full flex flex-col relative">
          <div className="flex-grow overflow-y-auto pt-[3.25rem] scrollbar-hidden relative">
            <div className="max-w-4xl mx-auto p-4" ref={targetRef}>
              <Preview data={data} theme={currentTheme} />
            </div>
          </div>

          <div className="absolute bottom-0 left-0 right-0 p-4 flex justify-center items-center pointer-events-none">
            <div className="max-w-4xl mx-auto pointer-events-auto">
              <div className="bg-white/50 backdrop-blur-sm rounded-lg p-2 shadow-lg">
                <ThemeSelector 
