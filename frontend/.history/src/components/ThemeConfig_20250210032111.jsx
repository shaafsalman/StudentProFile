...
export const resumeThemes = {
  ...
  professionalPlus: {
    ...
    styles: {
      ...
      // Main content now starts right after sidebar
      header: 'col-span-8 col-start-5 p-8',
      ...
      // Sidebar starts at column 1
      sidebar: 'col-span-4 col-start-1 bg-gray-900 text-white p-6 flex flex-col gap-6 sticky top-0 h-screen',
      // Main content aligns with header
      main: 'col-span-8 col-start-5 p-8 pt-0',
