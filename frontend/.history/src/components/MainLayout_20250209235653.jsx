    ...
    <div className="h-screen w-screen overflow-hidden flex">
      <div className={`h-full transition-all duration-300 relative flex flex-col ${
        ...
        <div className="grow overflow-hidden relative">
          <div 
            ref={editorRef}
            className="h-full overflow-y-auto pr-4 -mr-4 overflow-x-hidden scrollbar-hidden"
            >
            <Editor 
              data={data} 
              setData={setData}
      ...
      <div className={`h-full transition-all duration-300 relative ${
        ...
        <div className="absolute top-0 left-0 right-0 z-10 px-6 py-3 backdrop-blur">
        ...
        <div className="h-full flex flex-col">
          <div className="flex-grow overflow-y-auto pt-[3.25rem]">
