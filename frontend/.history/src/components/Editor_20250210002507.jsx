...
export default function Editor({ data, setData }) {
  ...
  return (
    <div className="h-full overflow-y-auto scrollbar-hide p-4 border-r">
      <Section title="Personal Information" icon={User}>
        <ItemCard
          title="Personal Details"
          onDelete={() => {}} // Disable delete for personal info
        ...
        >
          <div className="space-y-3">
            ...
            <textarea
              ...
              className="resume-textarea w-full p-2.5 border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 focus:ring-2 focus:ring-accent dark:focus:ring-accent transition-all duration-200"
              rows={4}
