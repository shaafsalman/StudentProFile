...
import { Download, ChevronRight, ChevronLeft, Menu, X, Layout, PanelLeft } from 'lucide-react';
    ...
    <div className="h-screen w-screen overflow-hidden bg-slate-100 dark:bg-slate-900 flex">
      ...
      <div className={`h-full transition-all duration-300 relative flex flex-col ${
        ...
        <div className={`shrink-0 ${
          ...
          {/* Top Bar */}
          <div className="px-5 py-3 border-b border-slate-200/5">
      ...
      <div className={`h-full transition-all duration-300 relative ${
        ...
        <div className="h-full bg-slate-50 dark:bg-slate-900">
          <div className="h-full pt-[3.25rem] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-700">
        ...
        <div className={`absolute bottom-6 right-6 ${
          theme === 'dark' ? 'bg-slate-800/95' : 'bg-white/95'
        } backdrop-blur rounded-xl shadow-lg p-4 border ${
