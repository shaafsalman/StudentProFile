...
import { Download, ChevronRight, ChevronLeft, Maximize2, Minimize2, Settings, Menu, X, PanelLeftOpen, PanelLeftClose, Plus, Star, Mail, Phone, MapPin, Book, Briefcase, Code } from 'lucide-react';
...
const MainLayout = () => {
  ...
  const navigationItems = [
    ...
    { id: 'skills', label: 'Skills', icon: Codez, color: 'bg-red-500' }
  ];
