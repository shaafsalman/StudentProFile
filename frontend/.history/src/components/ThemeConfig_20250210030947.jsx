...
export const resumeThemes = {
  ...
  professionalPlus: {
    ...
    styles: {
      container: 'grid grid-cols-12 bg-white max-w-[800px] mx-auto min-h-[1000px]',
      header: 'col-span-9 col-start-4 p-8',
      ...
      sidebar: 'col-span-3 col-start-1 row-span-2 bg-gray-900 text-white p-6 flex flex-col gap-6 sticky top-0 h-screen',
      sidebarTitle: 'text-xs font-bold uppercase tracking-widest text-gray-400 mb-3 pb-2 border-b border-gray-800',
      sidebarContent: 'text-gray-300 text-sm',
      skills: 'inline-block bg-gray-800 px-2.5 py-1 rounded text-gray-300 text-xs mb-2 mr-2 last:mr-0 hover:bg-gray-700 transition-colors',
      skillsContainer: 'flex flex-wrap',
      sidebarSection: 'mb-6 last:mb-0',
      sidebarItem: 'mb-4 last:mb-0',
      sidebarSubtitle: 'text-gray-400 text-xs',
      
      // Main content
      main: 'col-span-9 col-start-4 p-8 pt-0',
      mainSection: 'mb-8 last:mb-0',
      experienceItem: 'mb-6 last:mb-0 pb-6 last:pb-0 border-b last:border-b-0 border-gray-100'
    }
  },
  minimalistCards: {
