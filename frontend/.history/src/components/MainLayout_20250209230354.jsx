      ...
      <div className={`h-full transition-all duration-300 relative flex flex-col ${
        ...
        <div className={`shrink-0 p-5 ${
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-md"
          >
            <Download size={18} />
