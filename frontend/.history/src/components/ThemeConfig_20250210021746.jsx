...
export const ThemeSelector = ({ currentTheme, onThemeChange, currentFont, onFontChange, currentAccentColor, onAccentColorChange }) => {
  ...
  return (
    <div className="flex items-center space-x-4 bg-white shadow-md p-3 rounded-lg">
    {/* CV Theme Selector */}
    <div className="relative menu-container">
      <button onClick={() => setMenuOpen({ ...menuOpen, theme: !menuOpen.theme })} className="flex items-center px-3 py-2 border rounded-lg shadow-sm bg-gray-100 hover:bg-gray-200">
    ...
    {/* Font Selector */}
    <div className="relative menu-container">
      <button onClick={() => setMenuOpen({ ...menuOpen, font: !menuOpen.font })} className="flex items-center px-3 py-2 border rounded-lg shadow-sm bg-gray-100 hover:bg-gray-200">
    ...
    {/* Color Selector */}
    <div className="relative menu-container">
      <button onClick={() => setMenuOpen({ ...menuOpen, color: !menuOpen.color })} className="flex items-center px-3 py-2 border rounded-lg shadow-sm bg-gray-100 hover:bg-gray-200">
