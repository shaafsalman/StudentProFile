...
<div className="relative ">
  {/* Row 1: Header + Font & Color Selectors */}
  <div className="flex justify-between items-center mb-4">
    ...
    <div className="flex items-center space-x-4">
      ...
      <div 
        className="flex items-center space-x-3 cursor-pointer bg-gray-100 p-2 rounded-lg shadow-md hover:bg-gray-200 menu-container"
  ...
  {/* Font Menu */}
  {fontMenuOpen && (
    <div className="absolute top-12 right-16 w-48 bg-white border rounded-lg shadow-lg p-3 space-y-4 menu-container">
  ...
  {/* Color Menu */}
  {colorMenuOpen && (
    <div className="absolute top-12 right-3 w-48 bg-white border rounded-lg shadow-lg p-3 space-y-4 menu-container">
