...
export const resumeThemes = {
  ...
  professionalPlus: {
    ...
    styles: {
      ...
      description: 'text-gray-600 mt-2 leading-relaxed',
      skills: 'bg-gray-800 px-3 py-1.5 rounded text-gray-300 text-sm mb-2 inline-block mr-2 hover:bg-gray-700 transition-colors duration-200',
      sidebar: 'col-span-3 bg-gray-900 text-white p-6 flex flex-col gap-8 min-h-full',
      main: 'col-span-9 p-8 pl-12',
      sidebarTitle: 'text-sm font-bold uppercase tracking-widest text-gray-400 mb-4 border-b border-gray-700 pb-2',
      sidebarContent: 'text-gray-300 text-sm leading-relaxed',
      sidebarSection: 'space-y-4',
      sidebarItem: 'border-b border-gray-800 pb-3 last:border-0',
      skillsGrid: 'flex flex-wrap gap-2',
      mainSection: 'mb-10 last:mb-0',
      experienceHeader: 'flex justify-between items-start mb-2 flex-wrap gap-2',
      projectCard: 'border-l-2 border-gray-200 pl-4 mb-6 last:mb-0 hover:border-gray-400 transition-colors duration-200',
      sidebarWrapper: 'sticky top-0',
      mainWrapper: 'pr-8'
    }
  },
  minimalistCards: {
