...
export const resumeThemes = {
  ...
  professionalPlus: {
    ...
    styles: {
      ...
      description: 'text-gray-600 mt-2 leading-relaxed',
      skills: 'bg-gray-100 px-2 py-1 rounded text-gray-700 text-xs',
      sidebar: 'bg-gray-900 text-white p-4 flex flex-col gap-4 sticky top-0 h-screen',
      main: 'p-8 pl-12',
      sidebarTitle: 'text-xs font-bold uppercase tracking-widest text-gray-400 mb-2',
      sidebarContent: 'text-gray-300 text-xs break-words'
    }
  },
  minimalistCards: {
