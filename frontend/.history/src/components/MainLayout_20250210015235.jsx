  ...
  return (
    <div className="h-screen w-screen overflow-hidden flex">
      <div className={`h-full transition-all duration-300 relative flex flex-col ${
        ...
        <div className="shrink-0 bg-transparent backdrop-blur-xl border-b-2 border-r-gray-5800">
      ...
      <div className={`h-full transition-all duration-300 relative ${
        ...
        <div className="absolute top-0 left-0 right-0 z-10 px-6 py-4  bg-background-light dark:bg-background-dark">
          <div className="flex items-center gap-4">
            {isEditorCollapsed && (
              <Button
                variant="ghost"
        ...
        <div className="h-full flex flex-col relative">
          ...
          <div className="absolute bottom-0 left-0 right-0  flex justify-center items-center pointer-events-none">
            <div className=" pointer-events-auto">
              <div className="bg-white/50 dark:bg-gray-200 backdrop-blur-md rounded-md p-4 shadow-lg">
                <ThemeSelector 
