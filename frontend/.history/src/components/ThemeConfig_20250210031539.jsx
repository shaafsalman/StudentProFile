...
export const resumeThemes = {
  ...
  professionalPlus: {
    ...
    styles: {
      container: 'grid grid-cols-5 bg-white max-w-[800px] mx-auto min-h-[1000px]',
      ...
      sidebar: 'col-span-2 bg-gray-900 text-white p-6 flex flex-col gap-6 sticky top-0 h-screen',
      main: 'p-8 pl-12',
