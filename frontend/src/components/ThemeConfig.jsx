          ...
          <div className="flex space-x-2">
            {accentColorOptions.map(color => (
              <button
                ...
                className={`w-7 h-7 rounded-full border-2 transition-all duration-200 hover:shadow-md ${color.value} ${
                  currentAccentColor === color.value ? 'border-accent shadow-md' : 'border-gray-300'
                }`}
              />
            ))}
          </div>
